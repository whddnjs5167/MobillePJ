...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmailText = findViewById(R.id.regiEmailEt);
        mPasswordText = findViewById(R.id.regiPassEt);
        mPasswordcheckText = findViewById(R.id.regiPassCheckEt);
        mregisterBtn = findViewById(R.id.registerCompliBt);
